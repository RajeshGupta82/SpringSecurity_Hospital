...
import com.rajesh.hospital.hospitalmanagement.dto.BloodGroupCountResponseEntity;
...
public interface PatientRepository extends JpaRepository<Patient, Long> {
    ...
    @Query("select new com.rajesh.hospital.hospitalmanagement.dto.BloodGroupCountResponseEntity(p.bloodGroup," +
